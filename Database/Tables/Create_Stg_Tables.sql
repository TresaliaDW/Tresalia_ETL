...
IF EXISTS (SELECT 1 FROM  sysobjects WHERE  id = OBJECT_ID('Stg.FileHistory') AND   TYPE = 'U')
...
if exists (select 1 from  sysobjects where  id = object_id('stg.Sector') and   type = 'U')
   drop table stg.Sector
go

if exists (select 1 from  sysobjects where  id = object_id('stg.Country') and   type = 'U')
   drop table stg.Country
go

if exists (select 1 from  sysobjects where  id = object_id('stg.Composites') and   type = 'U')
   drop table stg.Composites
go

if exists (select 1 from  sysobjects where  id = object_id('stg.Ratings') and   type = 'U')
   drop table stg.Ratings
go

if exists (select 1 from  sysobjects where  id = object_id('stg.FX') and   type = 'U')
   drop table stg.FX
go


if exists (select 1 from  sysobjects where  id = object_id('stg.FactSetUSFICoverage') and   type = 'U')
   drop table stg.FactSetUSFICoverage
go

if exists (select 1 from  sysobjects where  id = object_id('stg.FactSetIntlFICoverage') and   type = 'U')
   drop table stg.FactSetIntlFICoverage
go


if exists (select 1 from  sysobjects where  id = object_id('stg.FactSetEqBenchmarks') and   type = 'U')
   drop table stg.FactSetEqBenchmarks
go

if exists (select 1 from  sysobjects where  id = object_id('stg.FactSetFIBenchmarks') and   type = 'U')
   drop table stg.FactSetFIBenchmarks
go


if exists (select 1 from  sysobjects where  id = object_id('stg.PortfolioMaster') and   type = 'U')
   drop table stg.PortfolioMaster
go

if exists (select 1 from  sysobjects where  id = object_id('stg.LFI') and   type = 'U')
   drop table stg.LFI
go

if exists (select 1 from  sysobjects where  id = object_id('stg.MarshallWace') and   type = 'U')
   drop table stg.MarshallWace
go

if exists (select 1 from  sysobjects where  id = object_id('stg.TenorTnc') and   type = 'U')
   drop table stg.TenorTnc
go

if exists (select 1 from  sysobjects where  id = object_id('stg.TenorHoldings') and   type = 'U')
   drop table stg.TenorHoldings
go


if exists (select 1 from  sysobjects where  id = object_id('stg.BNYMonthly') and   type = 'U')
   drop table stg.BNYMonthly
go

if exists (select 1 from  sysobjects where  id = object_id('stg.MgrTNCRM') and   type = 'U')
   drop table stg.MgrTNCRM
go

if exists (select 1 from  sysobjects where  id = object_id('stg.BNYHoldings') and   type = 'U')
   drop table stg.BNYHoldings
go

if exists (select 1 from  sysobjects where  id = object_id('stg.BNYCFReport') and   type = 'U')
   drop table stg.BNYCFReport
go


if exists (select 1 from  sysobjects where  id = object_id('stg.IndexReturns') and   type = 'U')
   drop table stg.IndexReturns
go

if exists (select 1 from  sysobjects where  id = object_id('stg.PotentialManagers') and   type = 'U')
   drop table stg.PotentialManagers
go

if exists (select 1 from  sysobjects where  id = object_id('stg.PotentialManagersCodeIndex') and   type = 'U')
   drop table stg.PotentialManagersCodeIndex
go

if exists (select 1 from  sysobjects where  id = object_id('stg.StoneMiliner') and   type = 'U')
   drop table stg.StoneMiliner
go

if exists (select 1 from  sysobjects where  id = object_id('stg.AssetAllocation') and   type = 'U')
   drop table stg.AssetAllocation
go

if exists (select 1 from  sysobjects where  id = object_id('stg.EuroDollarSwapCurve') and   type = 'U')
   drop table stg.EuroDollarSwapCurve
go

if exists (select 1 from  sysobjects where  id = object_id('stg.IRSurface') and   type = 'U')
   drop table stg.IRSurface
go

if exists (select 1 from  sysobjects where  id = object_id('stg.TenorPositions') and   type = 'U')
   drop table stg.TenorPositions
go

IF EXISTS (SELECT 1 FROM  sysobjects WHERE  id = OBJECT_ID('stg.TenorTncOPT') AND   TYPE = 'U')
   DROP TABLE stg.TenorTncOPT
GO

IF EXISTS (SELECT 1 FROM  sysobjects WHERE  id = OBJECT_ID('stg.EqSurface') AND   TYPE = 'U')
   DROP TABLE stg.EqSurface
   
IF EXISTS (SELECT 1 FROM  sysobjects WHERE  id = OBJECT_ID('stg.MasterETFData') AND   TYPE = 'U')
   DROP TABLE stg.MasterETFData


IF EXISTS (SELECT 1 FROM  sysobjects WHERE  id = OBJECT_ID('stg.SwapCurve') AND   TYPE = 'U')
   DROP TABLE stg.SwapCurve

   
IF EXISTS (SELECT 1 FROM  sysobjects WHERE  id = OBJECT_ID('stg.BroadRidgeTrade') AND   TYPE = 'U')
   DROP TABLE stg.BroadRidgeTrade
   
   
IF EXISTS (SELECT 1 FROM  sysobjects WHERE  id = OBJECT_ID('stg.CompositeAsset') AND   TYPE = 'U')
   DROP TABLE stg.CompositeAsset
GO
...
create table stg.FactSetUSFICoverage (
...
create table stg.FactSetIntlFICoverage (
...
CREATE TABLE stg.FactSetEqBenchmarks (
    [FileName]		Varchar(100)		not null,
    [FilePath]		Varchar(100)		not null,
    [TabName]           varchar(100)		not null,
...
CREATE TABLE stg.FactSetFIBenchmarks (
    [FileName]									Varchar(100)		not null,
	[FilePath]									Varchar(100)		not null,
	[TabName]									Varchar(100),
	[NDT/DB] varchar(100),
...
create table stg.PortfolioMaster (
...
CREATE TABLE stg.TenorHoldings (
	[FileName]									Varchar(100)		not null,
	[FilePath]									Varchar(100)		not null,
	[TabName]									Varchar(100),
	[As Of Date Recent] 						Varchar(100),
...
/*==============================================================*/
/* Table: Stg.IndexReturns                                 */
/*==============================================================*/
create table stg.IndexReturns (
...
/*==============================================================*/
/* Table: Stg.PotentialManagers                                 */
/*==============================================================*/
create table stg.PotentialManagers (
...
/*==============================================================*/
/* Table: Stg.PotentialManagersCodeIndex                        */
/*==============================================================*/
create table stg.PotentialManagersCodeIndex (
...
/*==============================================================*/
/* Table: Stg.StoneMiliner                                      */
/*==============================================================*/
create table stg.StoneMiliner (
[FileName]					Varchar(100)		not null,
[FilePath]					Varchar(100)		not null,
[TabName]					Varchar(100)		not null,
...
/*==============================================================*/
/* Table: Stg.AssetAllocation                                   */
/*==============================================================*/
create table stg.AssetAllocation (
[FileName]					Varchar(100)		not null,
[FilePath]					Varchar(100)		not null,
[TabName]					Varchar(100)		not null,
[Valuation_Date]			Varchar(100)		NULL,
...
/*==============================================================*/
/* Table: Stg.EuroDollarSwapCurve                               */
/*==============================================================*/
create table stg.EuroDollarSwapCurve (
[FileName]					Varchar(100)		not null,
[FilePath]					Varchar(100)		not null,
[TabName]					Varchar(100)		not null,
[Valuation_Date]			Varchar(100)		NULL,
...
/*==============================================================*/
/* Table: Stg.TenorPositions                                      */
/*==============================================================*/
create table stg.TenorPositions (
...
/*==============================================================*/
/* Table: Stg.TenorTncOPT                                     */
/*==============================================================*/

CREATE TABLE stg.TenorTncOPT (
...
/*==============================================================*/
/* Table: Stg.MasterETFData                                     */
/*==============================================================*/

CREATE TABLE [stg].[MasterETFData](
	[FileName] [varchar](100) NOT NULL,
	[FilePath] [varchar](100) NOT NULL,
	[TabName] [varchar](100) NOT NULL,
...
/*==============================================================*/
/* Table: Stg.BroadRidgeTrade                                     */
/*==============================================================*/

create table stg.BroadRidgeTrade(
...
/*==============================================================*/
/* Table: Stg.CompositeAsset                                    */
/*==============================================================*/

create table stg.CompositeAsset(
